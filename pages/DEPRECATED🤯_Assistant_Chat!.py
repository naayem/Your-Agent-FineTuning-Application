...
class StreamlitChatbot:
    ...
    def fetch_openai_ft_models(_self):
        ...
        openai_client = openai.OpenAI(api_key=st.secrets["OPENAI_TOKEN"])
        ft_openai_models = [model["id"] for model in openai_client.models.list()["data"] if model["owned_by"] == "epfl-42"]
    ...
    def display_sidebar(self):
        ...
        with st.sidebar:
            ...
            st.session_state.voice = st.selectbox("Select a voice", voices)
